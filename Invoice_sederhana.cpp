...
int main(){
	...
	cout<<"*********DAFTAR MENU MAKANAN & MINUMAN  SUKSES***********"<<endl;
    cout<<"1. Ayam bakar				Rp. 8000"<<endl;
    cout<<"2. steak				Rp. 1500000"<<endl;
    cout<<"3. Tea (Es/panas)			Rp. 2000"<<endl;
    cout<<"4. Jeruk (Es/panas)			Rp. 3000"<<endl;
     cout<<"5. Nasi goreng                           Rp.7000"<<endl;
    ...
    while(selesai==false){
    	...
    	if (pilih[i]<=5){
    		...
    		if (pilih[i]==0){
				...
				switch (pilih[i]){
		    		case 1 : menu[i]="AYAM BAKAR     "; harga[i]=12000; break;
		    		case 2 : menu[i]="steak     "; harga[i]=15000; break;
		    		case 3 : menu[i]="Tea (es/panas)  "; harga[i]=2000; break;
		    		case 4 : menu[i]="Jeruk (es/panas)"; harga[i]=3000; break;
		    		default : menu[i]="Nasi goreng";harga[i]=7000;
				}
